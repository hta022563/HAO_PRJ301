...
public class UniversityDTO {
   ...
   private int totalStudents, totalFaculties;
    ...
    public UniversityDTO(String id, String name, String shortName, String description, int foundedYear, String address, String city, String region, String type, boolean isDraft, int totalStudents, int totalFaculties) {
        this.id = id;
        this.name = name;
