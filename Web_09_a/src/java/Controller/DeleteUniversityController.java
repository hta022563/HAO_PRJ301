...
public class DeleteUniversityController extends HttpServlet {
     ...
     * @throws ServletException if DeleteUniversityController servlet-specific error occurs
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (!id.isEmpty()) {
            ...
            request.setAttribute("msg", "Error, con not delete:" + id);
            }
        }
    ...
    /**
     * Returns DeleteUniversityController short description of the servlet.
     *
     * @return DeleteUniversityController String containing servlet description
     */
    @Override
